...
fun StatementScreen(
    ...
    val removedMessage = stringResource(R.string.snackbar_removed)

    LaunchedEffect(message) {
        when (message) {
            StatementMessage.SAVED -> snackbarHostState.showSnackbar(savedMessage)
            StatementMessage.REMOVED -> snackbarHostState.showSnackbar(removedMessage)
